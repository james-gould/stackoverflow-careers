...
function UrlBuilder(props) {
    ...
    if(props.techDisliked) { 
        builtUrl += Utils.TechDisliked + ArrToUrl(Utils.EncodeProtectedCharacters(props.techDisliked));
    }

    if(props.techLiked) { 
        builtUrl += Utils.TechLiked + ArrToUrl(Utils.EncodeProtectedCharacters(props.techLiked));
    }
